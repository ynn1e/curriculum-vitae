...
主に Web フロントエンド開発、バックエンド開発、プロダクトの運用保守など、包括的なエンジニアリングを担当した。
...
大学・大学院で「人にやさしい情報システム」について研究した経験は、私のエンジニアリングにおけるモチベーションとなっています。
...
このように、エンジニアリングの先でプロダクトがどう働いているのか知ること、プロダクトがどうあるべきかを考えることについて積極的です。
